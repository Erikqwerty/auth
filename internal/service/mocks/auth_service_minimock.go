...
//go:generate minimock -i github.com/erikqwerty/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
func (mmCreateUser *mAuthServiceMockCreateUser) Expect(ctx context.Context, user *model.CreateUser) *mAuthServiceMockCreateUser {
...
func (mmCreateUser *mAuthServiceMockCreateUser) ExpectUserParam2(user *model.CreateUser) *mAuthServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("AuthServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mAuthServiceMockCreateUser) Inspect(f func(ctx context.Context, user *model.CreateUser)) *mAuthServiceMockCreateUser {
...
func (mmCreateUser *mAuthServiceMockCreateUser) Set(f func(ctx context.Context, user *model.CreateUser) (i1 int64, err error)) *AuthServiceMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mAuthServiceMockCreateUser) When(ctx context.Context, user *model.CreateUser) *AuthServiceMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("AuthServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *AuthServiceMock) CreateUser(ctx context.Context, user *model.CreateUser) (i1 int64, err error) {
...
func (mmGetUser *mAuthServiceMockGetUser) Expect(ctx context.Context, email string) *mAuthServiceMockGetUser {
	...
	mmGetUser.defaultExpectation.params = &AuthServiceMockGetUserParams{ctx, email}
...
// ExpectEmailParam2 sets up expected param email for AuthService.GetUser
func (mmGetUser *mAuthServiceMockGetUser) ExpectEmailParam2(email string) *mAuthServiceMockGetUser {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("AuthServiceMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mAuthServiceMockGetUser) Inspect(f func(ctx context.Context, email string)) *mAuthServiceMockGetUser {
...
func (mmGetUser *mAuthServiceMockGetUser) Set(f func(ctx context.Context, email string) (up1 *model.UserInfo, err error)) *AuthServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
// Then helper
func (mmGetUser *mAuthServiceMockGetUser) When(ctx context.Context, email string) *AuthServiceMockGetUserExpectation {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("AuthServiceMock.GetUser mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockGetUserExpectation{
		mock:               mmGetUser.mock,
		params:             &AuthServiceMockGetUserParams{ctx, email},
...
func (mmGetUser *AuthServiceMock) GetUser(ctx context.Context, email string) (up1 *model.UserInfo, err error) {
	...
	mm_params := AuthServiceMockGetUserParams{ctx, email}
	...
	if mmGetUser.GetUserMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetUserParams{ctx, email}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmGetUser.t.Errorf("AuthServiceMock.GetUser got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGetUser.t.Fatalf("Unexpected call to AuthServiceMock.GetUser. %v %v", ctx, email)
	return
}
...
func (mmUpdateUser *mAuthServiceMockUpdateUser) Expect(ctx context.Context, user *model.UpdateUser) *mAuthServiceMockUpdateUser {
...
func (mmUpdateUser *mAuthServiceMockUpdateUser) ExpectUserParam2(user *model.UpdateUser) *mAuthServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("AuthServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mAuthServiceMockUpdateUser) Inspect(f func(ctx context.Context, user *model.UpdateUser)) *mAuthServiceMockUpdateUser {
...
func (mmUpdateUser *mAuthServiceMockUpdateUser) Set(f func(ctx context.Context, user *model.UpdateUser) (err error)) *AuthServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mAuthServiceMockUpdateUser) When(ctx context.Context, user *model.UpdateUser) *AuthServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("AuthServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *AuthServiceMock) UpdateUser(ctx context.Context, user *model.UpdateUser) (err error) {
